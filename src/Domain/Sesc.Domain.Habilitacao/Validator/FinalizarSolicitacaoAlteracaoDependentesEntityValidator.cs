...
{
    public class FinalizarSolicitacaoAlteracaoDependentesEntityValidator : Validator<Solicitacao>
    {
        public override void SetRules()
        {
            ...
            RuleFor(s => s.Titular)
                .SetValidator(new FinalizarTitularAlteracaoDependenteEntityValidator());
        }
    }
}
