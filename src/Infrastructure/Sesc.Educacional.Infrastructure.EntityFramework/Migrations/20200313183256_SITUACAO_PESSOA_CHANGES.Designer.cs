...
namespace Sesc.MeuSesc.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20200313183256_SITUACAO_PESSOA_CHANGES")]
    partial class SITUACAO_PESSOA_CHANGES
    {
            ...
            modelBuilder.Entity("Sesc.Domain.Habilitacao.Entities.Contato", b =>
                {
                    ...
                    b.Property<string>("DddPrincipal")
                        .IsRequired()
                        .HasConversion(new ValueConverter<string, string>(v => default(string), v => default(string), new ConverterMappingHints(size: 64)))
                        .HasColumnName("DDD_PRINCIPAL")
                        .HasColumnType("varchar(2)");

                    b.Property<string>("DddSecundario")
                        .HasConversion(new ValueConverter<string, string>(v => default(string), v => default(string), new ConverterMappingHints(size: 64)))
                        .HasColumnName("DDD_SECUNDARIO")
                        .HasColumnType("varchar(2)");
